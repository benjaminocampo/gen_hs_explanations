...
def main(csv_pred, csv_gold):
    ...
    print(overall_df)
    overall_df.to_csv(f"overall_results_{csv_pred}", index=False)
    ...
    functionality_df.to_csv(f"func_results_{csv_pred}", index=False)
...
if __name__ == "__main__":
    ...
    main(args.csv_pred, args.csv_gold)
